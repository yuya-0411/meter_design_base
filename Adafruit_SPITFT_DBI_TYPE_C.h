...
public:
  ...
  */
  ...
  uint8_t redBrightness(uint16_t color);
  uint8_t greenBrightness(uint16_t color);
  uint8_t blueBrightness(uint16_t color);
...
#endif // end _ADAFRUIT_SPITFT_DBI_TYPE_C_H_
